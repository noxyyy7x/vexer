...
<div style="max-width:600px;margin:0 auto;background:#0a0a0f;padding:40px 20px;">
  ...
  <div style="text-align:center;margin-bottom:32px;">
    <div style="font-size:11px;letter-spacing:6px;color:rgba(255,255,255,0.4);margin-bottom:12px;">YOUR ORDER IS ON ITS WAY</div>
    <h1 style="font-size:28px;font-weight:700;color:#fff;margin:0 0 8px;">IT'S BEEN DISPATCHED</h1>
    <p style="font-size:13px;color:rgba(255,255,255,0.4);margin:0;">Your jersey is now on its way to you</p>
  </div>
  <div style="background:rgba(255,255,255,0.06);border:1px solid rgba(255,255,255,0.12);border-radius:8px;padding:24px;text-align:center;margin-bottom:28px;">
    ...
    <div style="font-size:20px;font-weight:700;color:#fff;margin-bottom:16px;">${orderNumber}</div>
    <div style="font-size:10px;letter-spacing:4px;color:rgba(255,255,255,0.4);margin-bottom:8px;">TRACKING NUMBER</div>
    <div style="font-size:24px;font-weight:700;color:#fff;letter-spacing:0.1em;">${trackingNumber}</div>
  </div>
  <div style="background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.08);border-radius:8px;padding:20px;margin-bottom:28px;">
    ...
    <div style="font-size:12px;color:rgba(255,255,255,0.5);line-height:2;">
      Worldwide delivery · Approximately 2 weeks<br/>
      Use your tracking number to monitor your delivery
    </div>
  </div>
