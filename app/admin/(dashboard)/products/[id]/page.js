    ...
    <div>
      ...
      <form onSubmit={handleSave}>
        ...
        <div className="vx-card" style={{ padding: 24, marginBottom: 20 }}>
          ...
          <div style={{ fontSize: 11, color: 'rgba(255,255,255,0.35)', marginBottom: 14 }}>The first image is used as the primary card image on the storefront.</div>
          <MultiImageUploader bucket="product-images" images={images} onChange={setImages} />
        </div>
